...
const services = [
  ...
  // },
  {
    title: "Mushaf Per Kata",
    description:
      "Jelajahi mushaf digital interaktif dengan analisis morfologi, audio tilawah Alafasy, dan pencarian cepat setiap lafadz.",
    link: "/qmushaf",
    icon: (
      <svg
        className="w-7 h-7"
  ...
  {
    title: "Kamus Al-Qur'an",
    description:
      "Kamus komprehensif Jamid Mabny, Harf Ghair 'Amil, Harf 'Amil, dan 80 Akar Kata Musytaq dengan dukungan 39 bahasa dunia.",
    link: "/qkamus",
    icon: (
      <svg
        className="w-7 h-7"
