...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Tajik (tg.ayati) and Tamil (ta.tamil) Quran translations
for all 114 Surahs (6,236 verses) and cache into tg_translations.json and ta_translations.json.
"""
...
targets = [
    ('tg', 'tg.ayati', 'tg_translations.json', 'AbdolMohammad Ayati (Тоҷикӣ)'),
    ('ta', 'ta.tamil', 'ta_translations.json', 'Jan Trust Foundation (தமிழ்)')
]
...
print("\nAll Tajik and Tamil translations successfully fetched and cached!")
