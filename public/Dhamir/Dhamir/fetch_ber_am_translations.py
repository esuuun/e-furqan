...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Amazigh (ber.mensur) and Amharic (am.sadiq) Quran translations
for all 114 Surahs (6,236 verses) and cache into ber_translations.json and am_translations.json.
"""
...
targets = [
    ('ber', 'ber.mensur', 'ber_translations.json', 'Ramdane At Mansour (Tamaziɣt)'),
    ('am', 'am.sadiq', 'am_translations.json', 'Muhammed Sadiq & Muhammed Sani Habib (አማርኛ)')
]
...
print("\nAll Amazigh and Amharic translations successfully fetched and cached!")
