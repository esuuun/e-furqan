...
# -*- coding: utf-8 -*-
"""
Master verification script for all 39 languages in Dhamir & Harf Web Application.
"""
...
LANGS = [
    ...
    ('NO', 'no', 'no_translations.json'),
    ('PL', 'pl', 'pl_translations.json'),
    ('RO', 'ro', 'ro_translations.json'),
    ('SV', 'sv', 'sv_translations.json'),
    ('TG', 'tg', 'tg_translations.json'),
    ('TA', 'ta', 'ta_translations.json'),
    ('TT', 'tt', 'tt_translations.json'),
    ('UG', 'ug', 'ug_translations.json'),
    ('UZ', 'uz', 'uz_translations.json'),
    ('KU', 'ku', 'ku_translations.json'),
]

print("=" * 75)
print("MASTER VERIFIKASI 39 BAHASA APLIKASI WEB DHAMIR & HARF")
print("=" * 75)

# 1. Check translation caches
print("\n[1/6] Memeriksa Cache Terjemahan 39 Bahasa...")
...
print("\n[2/6] Memeriksa Kelengkapan 299 Entri Jamid Mabny di 39 Bahasa...")
...
print("\n[3/6] Memeriksa Kelengkapan 187 Entri Harf Ghair 'Amil di 39 Bahasa...")
...
print("\n" + "=" * 75)
print("SELURUH 39 BAHASA (TERMASUK TATAR, UYGHUR, UZBEK, KURDISH) 100% TERVERIFIKASI & SIAP!")
print("=" * 75)
