...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Czech (cs.hrbek) and Dhivehi (dv.divehi) Quran translations
for all 114 Surahs (6,236 verses) and cache into cs_translations.json and dv_translations.json.
"""
...
targets = [
    ('cs', 'cs.hrbek', 'cs_translations.json', 'Alois Richard Hrbek (Čeština)'),
    ('dv', 'dv.divehi', 'dv_translations.json', 'Office of the President of Maldives (ދިވެހި)')
]
...
print("\nAll Czech and Dhivehi translations successfully fetched and cached!")
