...
# -*- coding: utf-8 -*-
"""
Master Verification Script for all 23 Languages:
ID, EN, MS, FR, DE, UR, HI, BN, RU, ZH, ES, TR, PT, HA, SW, FA, JA, KO, NL, IT, BS, SQ, TH
"""
...
LANGS = ['id', 'en', 'ms', 'fr', 'de', 'ur', 'hi', 'bn', 'ru', 'zh', 'es', 'tr', 'pt', 'ha', 'sw', 'fa', 'ja', 'ko', 'nl', 'it', 'bs', 'sq', 'th']

print("=" * 75)
print("MASTER VERIFIKASI 23 BAHASA APLIKASI WEB DHAMIR & HARF")
print("=" * 75)

# 1. Check all translation caches
print("\n[1/6] Memeriksa Cache Terjemahan 23 Bahasa...")
for lang in LANGS:
    if lang == 'id':
...
print("\n[2/6] Memeriksa Kelengkapan 299 Entri Jamid Mabny di 23 Bahasa...")
...
print("\n[3/6] Memeriksa Kelengkapan 187 Entri Harf Ghair 'Amil di 23 Bahasa...")
...
assert 'value="ar"' not in html, "Option for ar should NOT be in index.html!"
print("  [OK] Option value=\"ar\" berhasil dibatalkan/dihapus dari dropdown")
...
assert 'ar: {' not in app_js, "I18N.ar should NOT be in app.js!"
print("  [OK] I18N.ar berhasil dibatalkan/dihapus dari app.js")
...
print("\n" + "=" * 75)
print("SELURUH 23 BAHASA (TERMASUK THAI) 100% TERVERIFIKASI & SIAP!")
print("=" * 75)
