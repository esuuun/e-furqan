...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Azerbaijani (az.mammadaliyev) and Bulgarian (bg.theophanov) Quran translations
for all 114 Surahs (6,236 verses) and cache into az_translations.json and bg_translations.json.
"""
...
targets = [
    ('az', 'az.mammadaliyev', 'az_translations.json', 'Vasim Məmmədəliyev & Ziya Bünyadov (Azərbaycan dili)'),
    ('bg', 'bg.theophanov', 'bg_translations.json', 'Цветан Теофанов (Български)')
]
...
print("\nAll Azerbaijani and Bulgarian translations successfully fetched and cached!")
