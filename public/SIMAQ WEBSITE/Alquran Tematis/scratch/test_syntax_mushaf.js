                        ...
                        <div class="keyword-verse-card" id="${vCardId}" data-surah="${v.surah_num}" data-ayat="${v.ayat_num}">
                            ...
                            <div class="search-actions-bar">
                                ...
                                <div class="search-action-btns-right">
                                    <button class="nav-action-btn secondary-btn" style="padding: 0.5rem 1rem; font-size: 0.88rem;" onclick="openMushafPerKata(${v.surah_num}, ${v.ayat_num}, event)">
                                        ${lblOpenSearch}
                                    </button>
                                    ${topic ? `
                                ...
                                <div class="flip-card-inner">
                                    <div class="flip-card-front" data-surah="${v.surah_num}" data-ayat="${v.ayat_num}" data-indo="${encodeURIComponent(v.indo)}">
                                        ...
                                        <div style="display: flex; gap: 0.75rem; justify-content: center; flex-wrap: wrap; margin-top: 1rem;">
                                            ...
                                            <button class="tts-button" style="color: #38bdf8; border-color: #38bdf8; background-color: rgba(56, 189, 248, 0.1);" onclick="openMushafPerKata(${v.surah_num}, ${v.ayat_num}, event)" title="Lihat Mushaf Per Kata">
