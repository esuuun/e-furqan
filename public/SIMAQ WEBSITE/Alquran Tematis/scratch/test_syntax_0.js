        ...
        const LANG_UI_MAP = {
            'en': {
                ...
                'Lihat Mushaf Per Kata': 'View Word-by-Word Mushaf',
            ...
            'ar': {
                ...
                'Lihat Mushaf Per Kata': 'عرض المصحف كلمة بكلمة',
            ...
            'ms': {
                ...
                'Lihat Mushaf Per Kata': 'Lihat Mushaf Per Kata',
                'Cari Ayat': 'Cari Ayat',
            ...
            'ur': {
                ...
                'Lihat Mushaf Per Kata': 'مصحف لفظ بہ لفظ دیکھیں',
            ...
            'tr': {
                ...
                'Lihat Mushaf Per Kata': 'Kelime Kelime Mushafı Görüntüle',
                'Cari Ayat': 'Ayet Ara',
                'Tema Besar:': 'Ana Tema:',
            ...
            'fr': {
                ...
                'Lihat Mushaf Per Kata': 'Voir le Coran mot à mot',
        ...
        function getWhatsAppTemplates(langCode) {
            const templates = {
                'id': {
...
${specificInstruction}`;
                        ...
                        <div class="keyword-verse-card" id="${vCardId}" data-surah="${v.surah_num}" data-ayat="${v.ayat_num}">
                            ...
                            <div class="search-actions-bar">
                                <div class="search-action-btns-left">
                                    ...
                                    <button class="tts-button" style="color: #25d366; border-color: rgba(37, 211, 102, 0.4); background-color: rgba(37, 211, 102, 0.1);" onclick="shareAyatWhatsApp('${v.surah_name}', ${v.surah_num}, ${v.ayat_num}, event)" title="${lblShare}">
                                ...
                                <div class="flip-card-inner">
                                    <div class="flip-card-front" data-surah="${v.surah_num}" data-ayat="${v.ayat_num}" data-indo="${encodeURIComponent(v.indo)}">
                                        ...
                                        <div style="display: flex; gap: 0.75rem; justify-content: center; flex-wrap: wrap; margin-top: 1rem;">
                                            ...
                                            <button class="tts-button" style="color: #38bdf8; border-color: #38bdf8; background-color: rgba(56, 189, 248, 0.1);" onclick="lookupVerseInSearch(${v.surah_num}, ${v.ayat_num}, event)" title="Lihat Mushaf Per Kata">
                    ...
                    <div class="search-card-front" data-surah="${surahNum}" data-ayat="${ayatNum}" data-indo="${encodeURIComponent(verseObj.indo)}">
                        ...
                        <div class="search-actions-bar">
                            <div class="search-action-btns-left">
                                ...
                                <button class="tts-button" style="color: #25d366; border-color: rgba(37, 211, 102, 0.4); background-color: rgba(37, 211, 102, 0.1);" onclick="shareAyatWhatsApp('${surahInfo.name}', ${surahNum}, ${ayatNum}, event)" title="Bagikan Ayat ke WhatsApp">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
        ...
        function shareAyatWhatsApp(surahName, surahNum, ayatNum, event) {
            if (event) event.stopPropagation();
            let card = null;
            if (event && event.target) {
