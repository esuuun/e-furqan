...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Quran translations for:
- Tatar (tt.nugman)
- Uyghur (ug.saleh)
- Uzbek (uz.sodik)
- Kurdish (ku.asan)
for all 114 Surahs (6,236 verses each).
"""
...
targets = [
    ('tt', 'tt.nugman', 'tt_translations.json', 'Якуб ибн Нугман (Татарча)'),
    ('ug', 'ug.saleh', 'ug_translations.json', 'محمد صالح (ئۇيغۇرچە)'),
    ('uz', 'uz.sodik', 'uz_translations.json', 'Муҳаммад Содиқ (O\'zbekcha)'),
    ('ku', 'ku.asan', 'ku_translations.json', 'بورهان موحەممەد ئەمین (کوردی)')
]
...
print("\nAll 4 translations successfully fetched and cached!")
