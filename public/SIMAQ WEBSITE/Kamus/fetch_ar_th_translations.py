...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Arabic (ar.muyassar) and Thai (th.thai) Quran translations / Tafsir
for all 114 Surahs (6,236 verses) and cache into ar_translations.json and th_translations.json.
"""
...
targets = [
    ('ar', 'ar.muyassar', 'ar_translations.json', 'Tafsir Al-Muyassar (مجمع الملك فهد)'),
    ('th', 'th.thai', 'th_translations.json', 'King Fahd Complex / Thai Translation (ภาษาไทย)')
]
...
print("\nAll Arabic and Thai translations successfully fetched and cached!")
