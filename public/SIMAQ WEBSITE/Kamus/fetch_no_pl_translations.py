...
# -*- coding: utf-8 -*-
"""
Script to fetch complete Norwegian (no.berg) and Polish (pl.bielawskiego) Quran translations
for all 114 Surahs (6,236 verses) and cache into no_translations.json and pl_translations.json.
"""
...
targets = [
    ('no', 'no.berg', 'no_translations.json', 'Einar Berg (Norsk)'),
    ('pl', 'pl.bielawskiego', 'pl_translations.json', 'Józef Bielawski (Polski)')
]
...
print("\nAll Norwegian and Polish translations successfully fetched and cached!")
